...
#define STRING_CONFIG_H_AUTHOR "nerohes" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "PrusaBear"
...
#define EXTRUDE_MINTEMP 130   //low because of wood-filament
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.79, 80, 398.2, 140.9 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 23, 5, -0.87 }
...
//#define Z_HOMING_HEIGHT  14      // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
 ...
 */
//#define RESTORE_LEVELING_AFTER_G28 //fuer ubl notwendig
...
#define MANUAL_X_HOME_POS 0    //HIER TODO
